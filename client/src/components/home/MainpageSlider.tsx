...
const MainpageSlider: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden -mt-[var(--header-height)]">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto px-4 text-white text-center">
              ...
              >
                <Link href={slides[currentSlide].cta1.link} className="bg-secondary hover:bg-opacity-90 text-secondary-foreground px-8 py-3 rounded-md font-medium hover-scale">
                  {slides[currentSlide].cta1.text}
                </Link>
                <Link href={slides[currentSlide].cta2.link} className="bg-transparent border-2 border-white hover:bg-white hover:text-primary text-white px-8 py-3 rounded-md font-medium transition-all">
